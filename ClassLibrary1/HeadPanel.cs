...
namespace ClassLibrary1
{
    public partial class HeadPanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            LinearGradientBrush linearGradientBrush = new LinearGradientBrush(new Rectangle(0, 0, this.Width, this.headHeight), GetColorLight(this.headBackColor, this.linearGradientRate), this.headBackColor, LinearGradientMode.Horizontal);
            graphics.FillRectangle(linearGradientBrush, 0, 0, this.Width, this.headHeight);
            Brush brush = new SolidBrush(this.headForeColor);
        ...
        private Color GetColorLight(Color color, float rate)
        {
